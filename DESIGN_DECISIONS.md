...
3. **Recompensa variable y horizonte largo**: golpes críticos (~10% de probabilidad de x2 XP), racha flexible *sin culpa* con **escudos acumulables** (mecánica tipo LinkedIn: cada 7 días de racha ganas 1 escudo, máx. 6; el primer día de descanso es gratis y cada día extra sin la app gasta un escudo — un retiro de una semana con el colchón lleno sobrevive), **días activos totales** que nunca se pierden aunque la racha se rompa, títulos de nivel (Novato→Mito) que dan sentido a la curva cuadrática de XP, y logros de largo horizonte (racha 100, 365 días totales, nivel 20, 50 misiones).
